...
for (const row of rows) {
    ...
    md += `- **Tên file:** \`${finalVisual}\`\n`;
    md += `- **Link Online:** [Xem ảnh trên GitHub](${githubRawBase}/${finalVisual})\n\n`;

    if (finalVisual.endsWith('.svg')) {
        const svgPath = path.join(usecasesDir, finalVisual);
...
console.log("Generated gemini_web_readable_report.md successfully.");
