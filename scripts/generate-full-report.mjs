...
let md = "# Báo Cáo Tổng Hợp Toàn Bộ Visual Đã Tinh Chỉnh (Lesson 1 - 30)\n\n";
...
const brainPath = "/C:/Users/DPC00212/.gemini/antigravity/brain/c2fc37b7-dd92-4bfc-b7a2-50bc818843ba";
...
for (const row of rows) {
    ...
    md += `| ${stt} | ${row.day} | ${id} | ${row.placeholder} | ![${row.placeholder}](${brainPath}/${row.visual}) |\n`;
    stt++;
    lessonStt++;
}

import fs from 'fs';
fs.writeFileSync('C:\\Users\\DPC00212\\.gemini\\antigravity\\brain\\c2fc37b7-dd92-4bfc-b7a2-50bc818843ba\\full_visual_report.md', md, 'utf8');
console.log("Full visual report generated.");
