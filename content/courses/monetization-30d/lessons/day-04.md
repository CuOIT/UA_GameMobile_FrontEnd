---
day: 4
title: "Session design for ad-friendly puzzle games"
module: "Week 1 - Monetization fundamentals"
stages: [idea, prototype]
related_terms: [Session length, Interstitial, Rewarded ad]
artifact: "Session rhythm map"
---

## Mục tiêu / Goal

Sau bài này, bạn tạo được **Session rhythm map** cho game Mobile Puzzle làm bằng Unity. Quyết định chính: Choose where ads can appear without breaking player trust.

Artifact này cập nhật field **metricTargets** trong Final Monetization Plan. Bạn không cần trở thành monetization specialist; bạn cần biết chỗ nào nên đặt ads/IAP, event nào phải đo, và khi nào phải rollback vì revenue đang làm hỏng retention hoặc trust.
...
![Session design for ad-friendly puzzle games](content/courses/monetization-30d/assets/usecases/day-04-monetization-chain.svg)
...
5. Cập nhật Final Monetization Plan field **metricTargets**.

## Final UA Plan Update

Thêm một đoạn ngắn vào **metricTargets**:
