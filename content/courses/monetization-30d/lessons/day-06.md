---
day: 6
title: "Ads format choice for Unity puzzle"
module: "Week 1 - Monetization fundamentals"
stages: [idea, prototype]
related_terms: [Rewarded ad, Interstitial, Banner]
artifact: "Ad format decision matrix"
---

## Mục tiêu / Goal

Sau bài này, bạn tạo được **Ad format decision matrix** cho game Mobile Puzzle làm bằng Unity. Quyết định chính: Choose a first ad format based on player control, session rhythm and measurement quality.

Artifact này cập nhật field **creativeMatrix** trong Final Monetization Plan. Bạn không cần trở thành monetization specialist; bạn cần biết chỗ nào nên đặt ads/IAP, event nào phải đo, và khi nào phải rollback vì revenue đang làm hỏng retention hoặc trust.
...
![Ads format choice for Unity puzzle](content/courses/monetization-30d/assets/usecases/day-06-monetization-chain.svg)
...
5. Cập nhật Final Monetization Plan field **creativeMatrix**.

## Final UA Plan Update

Thêm một đoạn ngắn vào **creativeMatrix**:
