---
day: 15
title: "Week 2 synthesis: monetization test build"
module: "Week 2 - Unity implementation and tracking"
stages: [prototype, live]
related_terms: [Acceptance criteria, QA, Build]
artifact: "Test build acceptance card"
---

## Mục tiêu / Goal

Sau bài này, bạn tạo được **Test build acceptance card** cho game Mobile Puzzle làm bằng Unity. Quyết định chính: Define the pass/fail rules for a monetization-ready build.

Artifact này cập nhật field **successCriteria** trong Final Monetization Plan. Bạn không cần trở thành monetization specialist; bạn cần biết chỗ nào nên đặt ads/IAP, event nào phải đo, và khi nào phải rollback vì revenue đang làm hỏng retention hoặc trust.
...
## Test build acceptance card mẫu
...
![Week 2 synthesis: monetization test build](content/courses/monetization-30d/assets/usecases/day-15-monetization-chain.svg)
...
5. Cập nhật Final Monetization Plan field **successCriteria**.

## Final UA Plan Update

Thêm một đoạn ngắn vào **successCriteria**:
