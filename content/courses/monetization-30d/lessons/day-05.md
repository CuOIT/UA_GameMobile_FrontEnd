---
day: 5
title: "First monetization hypothesis"
module: "Week 1 - Monetization fundamentals"
stages: [idea, prototype]
related_terms: [Hypothesis, ARPDAU, Retention]
artifact: "Monetization hypothesis card"
---

## Mục tiêu / Goal

Sau bài này, bạn tạo được **Monetization hypothesis card** cho game Mobile Puzzle làm bằng Unity. Quyết định chính: Write the first monetization hypothesis that can drive implementation.

Artifact này cập nhật field **hypothesis** trong Final Monetization Plan. Bạn không cần trở thành monetization specialist; bạn cần biết chỗ nào nên đặt ads/IAP, event nào phải đo, và khi nào phải rollback vì revenue đang làm hỏng retention hoặc trust.
...
## Monetization hypothesis card mẫu
...
![First monetization hypothesis](content/courses/monetization-30d/assets/usecases/day-05-monetization-chain.svg)
...
5. Cập nhật Final Monetization Plan field **hypothesis**.

## Final UA Plan Update

Thêm một đoạn ngắn vào **hypothesis**:
