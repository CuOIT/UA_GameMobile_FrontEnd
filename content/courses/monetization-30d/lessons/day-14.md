---
day: 14
title: "QA monetization in Unity release builds"
module: "Week 2 - Unity implementation and tracking"
stages: [prototype, live]
related_terms: [QA, Release build, Consent]
artifact: "Release build QA script"
---

## Mục tiêu / Goal

Sau bài này, bạn tạo được **Release build QA script** cho game Mobile Puzzle làm bằng Unity. Quyết định chính: Decide whether the build is monetization-test ready.
...
![QA monetization in Unity release builds](content/courses/monetization-30d/assets/usecases/day-14-monetization-chain.svg)
