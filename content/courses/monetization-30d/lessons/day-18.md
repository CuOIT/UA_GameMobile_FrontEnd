---
day: 18
title: "Retention vs monetization tradeoff"
module: "Week 3 - Metrics and diagnosis"
stages: [live, prototype]
related_terms: [Retention, D1, D7]
artifact: "Retention tradeoff board"
---

## Mục tiêu / Goal

Sau bài này, bạn tạo được **Retention tradeoff board** cho game Mobile Puzzle làm bằng Unity. Quyết định chính: Set guardrails for monetization changes that should be rolled back.
...
![Retention vs monetization tradeoff](content/courses/monetization-30d/assets/usecases/day-18-monetization-chain.svg)
