---
day: 25
title: "Pricing and regional assumptions"
module: "Week 4 - Offers, LiveOps and operations"
stages: [live, prototype]
related_terms: [Price tier, Regional pricing, LTV]
artifact: "Pricing assumption sheet"
---

## Mục tiêu / Goal

Sau bài này, bạn tạo được **Pricing assumption sheet** cho game Mobile Puzzle làm bằng Unity. Quyết định chính: Pick first price points and caveats for Android-first testing.

Artifact này cập nhật field **budget** trong Final Monetization Plan. Bạn không cần trở thành monetization specialist; bạn cần biết chỗ nào nên đặt ads/IAP, event nào phải đo, và khi nào phải rollback vì revenue đang làm hỏng retention hoặc trust.
...
![Pricing and regional assumptions](content/courses/monetization-30d/assets/usecases/day-25-monetization-chain.svg)
...
5. Cập nhật Final Monetization Plan field **budget**.

## Final UA Plan Update

Thêm một đoạn ngắn vào **budget**:
