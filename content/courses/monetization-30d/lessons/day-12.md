---
day: 12
title: "Store products and receipt readiness"
module: "Week 2 - Unity implementation and tracking"
stages: [prototype, live]
related_terms: [Receipt, Billing, Catalog]
artifact: "Store product readiness checklist"
---

## Mục tiêu / Goal

Sau bài này, bạn tạo được **Store product readiness checklist** cho game Mobile Puzzle làm bằng Unity. Quyết định chính: Decide which store-product readiness checks block a monetization test.
...
## Store product readiness checklist mẫu
...
![Store products and receipt readiness](content/courses/monetization-30d/assets/usecases/day-12-monetization-chain.svg)
