---
day: 13
title: "Monetization event taxonomy"
module: "Week 2 - Unity implementation and tracking"
stages: [prototype, live]
related_terms: [Event taxonomy, Impression, Purchase]
artifact: "Monetization event taxonomy"
---

## Mục tiêu / Goal

Sau bài này, bạn tạo được **Monetization event taxonomy** cho game Mobile Puzzle làm bằng Unity. Quyết định chính: Create the minimum event set needed to read monetization safely.
...
## Monetization event taxonomy mẫu
...
![Monetization event taxonomy](content/courses/monetization-30d/assets/usecases/day-13-monetization-chain.svg)
