---
day: 22
title: "Week 3 synthesis: metric decision rules"
module: "Week 3 - Metrics and diagnosis"
stages: [live, prototype]
related_terms: [Decision rule, Rollback, Scale]
artifact: "Metric decision rules"
---

## Mục tiêu / Goal

Sau bài này, bạn tạo được **Metric decision rules** cho game Mobile Puzzle làm bằng Unity. Quyết định chính: Define how monetization metrics will trigger action.
...
![Week 3 synthesis: metric decision rules](content/courses/monetization-30d/assets/usecases/day-22-monetization-chain.svg)
