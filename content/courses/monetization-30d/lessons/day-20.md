---
day: 20
title: "Ad mediation and waterfall basics"
module: "Week 3 - Metrics and diagnosis"
stages: [live, prototype]
related_terms: [Mediation, Waterfall, Bidding]
artifact: "Mediation readiness note"
---

## Mục tiêu / Goal

Sau bài này, bạn tạo được **Mediation readiness note** cho game Mobile Puzzle làm bằng Unity. Quyết định chính: Decide whether to keep one network or prepare mediation later.
...
![Ad mediation and waterfall basics](content/courses/monetization-30d/assets/usecases/day-20-monetization-chain.svg)
