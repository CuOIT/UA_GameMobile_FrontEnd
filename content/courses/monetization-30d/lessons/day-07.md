---
day: 7
title: "Week 1 synthesis: monetization guardrails"
module: "Week 1 - Monetization fundamentals"
stages: [idea, prototype]
related_terms: [Guardrail, Retention, Trust]
artifact: "Monetization guardrail sheet"
---

## Mục tiêu / Goal

Sau bài này, bạn tạo được **Monetization guardrail sheet** cho game Mobile Puzzle làm bằng Unity. Quyết định chính: Define what monetization must not do to the game experience.

Artifact này cập nhật field **killCriteria** trong Final Monetization Plan. Bạn không cần trở thành monetization specialist; bạn cần biết chỗ nào nên đặt ads/IAP, event nào phải đo, và khi nào phải rollback vì revenue đang làm hỏng retention hoặc trust.
...
## Monetization guardrail sheet mẫu
...
![Week 1 synthesis: monetization guardrails](content/courses/monetization-30d/assets/usecases/day-07-monetization-chain.svg)
...
5. Cập nhật Final Monetization Plan field **killCriteria**.

## Final UA Plan Update

Thêm một đoạn ngắn vào **killCriteria**:
