---
day: 2
title: "Puzzle economy roles: ads, IAP and progression"
module: "Week 1 - Monetization fundamentals"
stages: [idea, prototype]
related_terms: [Economy, Rewarded ad, Progression]
artifact: "Economy role map"
---

## Mục tiêu / Goal

Sau bài này, bạn tạo được **Economy role map** cho game Mobile Puzzle làm bằng Unity. Quyết định chính: Choose the monetization role that matches the puzzle loop and target player.

Artifact này cập nhật field **audience** trong Final Monetization Plan. Bạn không cần trở thành monetization specialist; bạn cần biết chỗ nào nên đặt ads/IAP, event nào phải đo, và khi nào phải rollback vì revenue đang làm hỏng retention hoặc trust.
...
![Puzzle economy roles: ads, IAP and progression](content/courses/monetization-30d/assets/usecases/day-02-monetization-chain.svg)
...
5. Cập nhật Final Monetization Plan field **audience**.

## Final UA Plan Update

Thêm một đoạn ngắn vào **audience**:
