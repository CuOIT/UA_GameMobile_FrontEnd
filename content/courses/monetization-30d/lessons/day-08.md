---
day: 8
title: "Ad SDK integration plan without gameplay coupling"
module: "Week 2 - Unity implementation and tracking"
stages: [prototype, live]
related_terms: [SDK, Event, ScriptableObject]
artifact: "Ad integration boundary plan"
---

## Mục tiêu / Goal

Sau bài này, bạn tạo được **Ad integration boundary plan** cho game Mobile Puzzle làm bằng Unity. Quyết định chính: Decide the technical boundary for ad loading, showing and analytics.

Artifact này cập nhật field **tracking** trong Final Monetization Plan. Bạn không cần trở thành monetization specialist; bạn cần biết chỗ nào nên đặt ads/IAP, event nào phải đo, và khi nào phải rollback vì revenue đang làm hỏng retention hoặc trust.
...
## Ad integration boundary plan mẫu
...
![Ad SDK integration plan without gameplay coupling](content/courses/monetization-30d/assets/usecases/day-08-monetization-chain.svg)
...
5. Cập nhật Final Monetization Plan field **tracking**.

## Final UA Plan Update

Thêm một đoạn ngắn vào **tracking**:
...
- [Google AdMob Unity quick start](https://developers.google.com/admob/unity/quick-start) - Unity integration entry point for mobile ad monetization.
- [Unity In-App Purchasing package](https://docs.unity3d.com/Packages/com.unity.purchasing@latest) - Unity package documentation for product configuration and purchase flows.
