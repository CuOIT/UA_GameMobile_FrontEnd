...
```text
![Hero visual: decision rule ladder](content/assets/usecases/day-25-hero-diagram.png)Type: hero operating diagram.
...
```text
![Data visual: call matrix](content/assets/usecases/day-25-data-visual.png)Type: data visual/chart or decision board.
